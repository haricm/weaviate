...
type Bucket struct {
	...
	flushCycle *cyclemanager.CycleManager2
...
func NewBucket(ctx context.Context, dir string, logger logrus.FieldLogger,
	...
	b.flushCycle = cyclemanager.New2(cyclemanager.DefaultMemtableFlushInterval, b.initFlushCycle)
	b.flushCycle.Start()
